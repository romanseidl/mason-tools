...
public class FlockersWithUI extends ChartedGUIState {
    //Display
    ...
    public Inspector getInspector() {
        ...
        //insp.setUpdatingAllInspectors(false);
        insp.addInspector(new TitledSimpleInspector(((Flockers) state).params, this, null), "Parameters");
        insp.addInspector(new TitledSimpleInspector(((Flockers) state).dataCollector, this, null), "Data");
        return insp;
    }

    @Override
    public DataCollector getDataCollector() {
        return ((Flockers) state).dataCollector;
    }
    ...
    public void setupPortrayals() {
        ...
        if (w == h) {
            display.insideDisplay.width = display.insideDisplay.height = layout.getDisplayWidth();
        } else if (w > h) {
    ...
    public void init(Controller c) {
        ...
        // make the displayer
        display = new Display2D(layout.getDisplayWidth(), layout.getDisplayWidth(), this);
